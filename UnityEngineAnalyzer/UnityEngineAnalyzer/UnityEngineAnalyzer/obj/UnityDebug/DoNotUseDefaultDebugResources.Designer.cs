...
namespace UnityEngineAnalyzer.UnityDebug
{
    ...
    [DebuggerNonUserCode()]
    [CompilerGenerated()]
    internal class DoNotUseDefaultDebugResources
    {
        ...
        internal DoNotUseDefaultDebugResources()
        {
        }
            ...
            get
            {
                if (ReferenceEquals(resourceMan, null))
                {
                    ResourceManager temp = new ResourceManager(
                        "UnityEngineAnalyzer.UnityDebug.DoNotUseDefaultDebugResources",
                        typeof(DoNotUseDefaultDebugResources).GetTypeInfo().Assembly);
                    resourceMan = temp;
                }
        ...
        /// <summary>
        ///     Looks up a localized string similar to use custom Debug instead of UnityEngine.Debug.
        /// </summary>
