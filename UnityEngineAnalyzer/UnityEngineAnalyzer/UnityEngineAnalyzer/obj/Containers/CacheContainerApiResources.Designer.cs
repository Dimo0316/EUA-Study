...
namespace UnityEngineAnalyzer.Containers
{
    ...
    [DebuggerNonUserCode()]
    [CompilerGenerated()]
    internal class CacheContainerApiResources
    {
        ...
        internal CacheContainerApiResources()
        {
        }
            ...
            get
            {
                if (ReferenceEquals(resourceMan, null))
                {
                    ResourceManager temp = new ResourceManager(
                        "UnityEngineAnalyzer.Containers.CacheContainerApiResources",
                        typeof(CacheContainerApiResources).GetTypeInfo().Assembly);
                    resourceMan = temp;
                }
        ...
        /// <summary>
        ///     Looks up a localized string similar to Cache the result of Unity API which returns a container.
        /// </summary>
