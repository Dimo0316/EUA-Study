...
namespace UnityEngineAnalyzer.ForbiddenMethods
{
    ...
    internal class ForbiddenMethodsResources
    {
        ...
        internal ForbiddenMethodsResources()
        {
        }
            ...
            get
            {
                if (ReferenceEquals(resourceMan, null))
                {
                    ResourceManager temp =
                        new ResourceManager("UnityEngineAnalyzer.ForbiddenMethods.ForbiddenMethodsResources",
                            typeof(ForbiddenMethodsResources).GetTypeInfo().Assembly);
                    resourceMan = temp;
                }
        ...
        /// <summary>
        ///     Looks up a localized string similar to Using ForEach in an Update could be slower and use more memory than a For
        ///     loop.
        /// </summary>
